...
<INPUT class="button" type="submit" value="删除" onClick="if(confirm('确定要删除吗')){form.action='?action=del';}else{return false};"/> </div><div class="right"  style="float:right;"><a href="http://www.aspcms.com/article-24-1.html" style="color:#aaaaaa" target="_blank">自定义标签使用帮助</a></div>
